...
\begin{figure*}
\centering
\includegraphics[width=\textwidth]{cu/mx_timeline}
...
for Brazil, viz. the planned protest model. Figure~\ref{fig:heideltime} shows an example of a Portuguese
...
the peak pretty well but was a bit delayed in picking up the increase in number of events.
